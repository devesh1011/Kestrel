...
export default function DotGlobeHeroDemo() {
  return (
    <div>
          ...
          >
            ...
            >
              <p
                ...
                style={{ fontFamily: "Inter, system-ui, sans-serif" }}
              >
                Borrow CTC against verifiable on-chain rewards with our{" "}
                <span className="text-foreground font-semibold bg-gradient-to-r from-primary/20 to-primary/10 px-2 py-1 rounded-md">
                  DePIN-native lending protocol
                </span>
              </p>
              <p className="text-lg text-muted-foreground/80 leading-relaxed">
                Node operators access instant liquidity while lenders earn yield
                from hardware rewards. Built on Creditcoin's Universal Smart
                Contract layer.
              </p>
            </motion.div>
          </motion.div>
      ...
      <Footer
        logo={<Image src="/logo.png" alt="Kestrel" width={40} height={40} />}
        brandName="Kestrel"
        socialLinks={[
          {
          ...
          },
          {
            ...
            href: "https://github.com/devesh1011/kestrel",
            label: "GitHub",
          },
        ]}
        mainLinks={[
